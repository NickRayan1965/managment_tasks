...
public class AuthController {
  ...
  @PostMapping("/login")
  public Mono<LoginResponseDto> login(@RequestBody LoginDto loginDto, @GetRequestUser User user) {
      return authService.login(loginDto);
  }

  @HasAuthority(Role.ADMIN)
  @PostMapping("/register")
  public Mono<UserDto> register(@RequestBody CreateUserDto createUserDto, @GetRequestUser User user) {
